<script setup>
    ...
    const form = useForm({
     ...
     const formTitle = computed(() => {
       return editedIndex.value === -1 ? 'Create New Role' : 'Edit Current Role'
    });
    ...
    const openEdit = (item) => {
        ...
        form.selectedPermissions = item.permissions
    };
    ...
    const deleteRole = (item) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                form.delete(route('admin.roles.destroy', item.id), {
                    preserveScroll: true,
                    onSuccess: ()=> {
                        Swal.fire(
                            'Deleted!',
                        ...
                        <form @submit.prevent="checkMode">
                            <div class="modal-body">
                                <div class="card card-primary">
                                    ...
                                    <div class="form-group">
                                        <label for="permissions" class="col-form-label" :class="{ 'text-danger' : form.errors.selectedPermissions }">Permissions</label>
                                        <VueMultiselect
                                        ...
                                        <div class="invalid-feedback mt-2" :class="{ 'd-block' : form.errors.selectedPermissions }">
